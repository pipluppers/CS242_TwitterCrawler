...
if len(sys.argv) < 3:
    print('Not enough command line arguments. Should have the python file, input file and output file')
    sys.exit()

#   My keys
consumer_key = 'HtiLY4pgQPIOp88Kfeo5G6joI'
consumer_secret = 'jQSN4k8xY7myUzLSQndDO6VXzAzSgpU9UvPhTlBnJ1G6vmu7Dy'
access_token = '598968456-b65n0OKFn2fODMrd4vSLiDpCyYWOhBsNS0ABLWts'
access_token_secret = 'oBq1XFyxVZVfVdInMFxDkCMfGz7GqEz0alP7IwcnMJjbH'
